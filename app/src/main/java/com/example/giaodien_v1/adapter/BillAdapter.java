...
public class BillAdapter extends RecyclerView.Adapter<BillAdapter.CartViewHolder> {
    ...
    public BillAdapter(Context mContext, ArrayList<Bill> bills){
        this.bills = bills;
    ...
    @NonNull
    @Override
    public BillAdapter.CartViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(mContext);
        View view = inflater.inflate(R.layout.bill_layout,null);
        BillAdapter.CartViewHolder cartViewHolder = new BillAdapter.CartViewHolder(view,mListener);
        return cartViewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull BillAdapter.CartViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btnCOnfirm.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        MainActivity.databaseHelper.changeToProcess(bills.get(position));
                        bills.clear();
                        bills.addAll(MainActivity.databaseHelper.getAllBill());
